                    ...
                    <Table>
                        <TableHeader className="bg-slate-50">
                            <TableRow className="border-none">
                                ...
                                <TableHead className="py-5 px-6 font-black uppercase text-[10px] tracking-widest text-slate-400 hidden sm:table-cell">Nutriscore (IA)</TableHead>
                                <TableHead className="py-5 px-6 font-black uppercase text-[10px] tracking-widest text-slate-400 hidden lg:table-cell">Temps</TableHead>
                                    ...
                                    <TableRow key={recipe.id} className="group hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <TableCell className="py-4 px-6 hidden sm:table-cell">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div className="flex items-center gap-1 text-slate-400 text-[10px] hidden lg:flex">
