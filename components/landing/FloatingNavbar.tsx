        ...
        >
            <div className="bg-white/60 backdrop-blur-xl border border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.05)] rounded-full px-8 py-4 flex items-center justify-between">
                <Link href="/" className="flex items-center gap-2 group">
                    ...
                    <span className="font-serif text-2xl tracking-tighter text-slate-900">IKONGA</span>
                </Link>
                ...
                <div className="flex items-center gap-4">
                    <Link
                        href="/login"
                        className="text-sm font-bold text-slate-900 hover:text-ikonga-pink transition-colors px-4 py-2"
                    >
                        Connexion
                    </Link>
                    <Link
                        href="/dashboard"
                        className="bg-ikonga-gradient text-white px-7 py-2.5 rounded-full text-sm font-bold shadow-lg shadow-pink-500/20 hover:scale-[1.05] transition-all active:scale-95"
                    >
                        Bilan Gratuit
                    </Link>
                </div>
